# This Makefile is for the Test::Exception extension to perl.
#
...
#     ABSTRACT_FROM => q[Exception.pm]
#     AUTHOR => q[Adrian Howard <adrianh@quietstars.com>]
#     NAME => q[Test::Exception]
#     PREREQ_PM => { Test::More=>q[0.44], Test::Builder=>q[0.13], Sub::Uplevel=>q[0.06], Test::Builder::Tester=>q[0.08] }
#     VERSION_FROM => q[Exception.pm]
...
AR_STATIC_ARGS = cr
NAME = Test::Exception
DISTNAME = Test-Exception
NAME_SYM = Test_Exception
VERSION = 0.16
VERSION_SYM = 0_16
XS_VERSION = 0.16
...
TO_INST_PM = Exception.pm

PM_TO_BLIB = Exception.pm \
...
manifypods : pure_all Exception.pm
	@$(POD2MAN) \
	Exception.pm \
	$(INST_MAN3DIR)/Test::Exception.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Test/Exception.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,16,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT>test functions for exception based code</ABSTRACT>\n\t<AUTHOR>Adrian Howard &lt;adrianh\@quietstars.com&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
	@$(PERL) -e "print qq{\t<IMPLEMENTATION>\n\t\t<DEPENDENCY NAME=\"Sub-Uplevel\" VERSION=\"0,06,0,0\" />\n\t\t<DEPENDENCY NAME=\"Test-Builder\" VERSION=\"0,13,0,0\" />\n\t\t<DEPENDENCY NAME=\"Test-Builder-Tester\" VERSION=\"0,08,0,0\" />\n\t\t<DEPENDENCY NAME=\"Test-More\" VERSION=\"0,44,0,0\" />\n}" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{Exception.pm blib/lib/Test/Exception.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
