# This Makefile is for the Test::Block extension to perl.
#
...
#     ABSTRACT_FROM => q[Block.pm]
#     AUTHOR => q[Adrian Howard <adrianh@quietstars.com>]
#     NAME => q[Test::Block]
#     PREREQ_PM => { Test::More=>q[0.47], Test::Builder=>q[0.17], Test::Builder::Tester=>q[0.09] }
#     VERSION_FROM => q[Block.pm]
...
manifypods : pure_all Block.pm
	@$(POD2MAN) \
	Block.pm \
	$(INST_MAN3DIR)/Test::Block.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,04,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT>specify fine granularity test plans</ABSTRACT>\n\t<AUTHOR>Adrian Howard &lt;adrianh\@quietstars.com&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
	@$(PERL) -e "print qq{\t<IMPLEMENTATION>\n\t\t<DEPENDENCY NAME=\"Test-Builder\" VERSION=\"0,17,0,0\" />\n\t\t<DEPENDENCY NAME=\"Test-Builder-Tester\" VERSION=\"0,09,0,0\" />\n\t\t<DEPENDENCY NAME=\"Test-More\" VERSION=\"0,47,0,0\" />\n}" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{Block.pm blib/lib/Test/Block.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
