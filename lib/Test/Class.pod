...
Thanks to Michael G Schwern, Tony Bowden, David Wheeler, Ovid, Corion, Terrence Brannon, anonymous RT bug submitters and all the fine folk on perl-qa for their feedback, patches, suggestions and nagging.
