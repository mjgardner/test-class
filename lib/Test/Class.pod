...
will run the test methods of the test object $test, unless L<$test->SKIP_CLASS()/"SKIP_CLASS"> returns a true value. 
...
You can see my current to do list at L<http://adrianh.tadalist.com/lists/show/4798>, with an RSS feed of changes at L<http://adrianh.tadalist.com/lists/feed_public/4798>.
...
Thanks to Michael G Schwern, Tony Bowden, David Wheeler, Ovid, Corion, Terrence Brannon and all the fine folk on perl-qa for their feedback, patches, suggestions and nagging.
